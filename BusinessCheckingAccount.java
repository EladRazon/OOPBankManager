...
public class BusinessCheckingAccount extends CheckingAccount implements ManagementFeeAccount, Cloneable {
    protected static final double VIP_REVENUE_THRESHOLD = 10000000; // Threshold for VIP business revenue
    protected static final int VIP_CLIENT_RANK = 10;
    ...
    public String toString() {
        ...
        return String.format("%-25s {accountNumber=%d, dateOpened=%s, bankNumber=%d, managerName='%s', balance=%.2f ₪, businessRevenue=%.2f ₪}",
                getAccountType(),
                getAccountNumber(),
